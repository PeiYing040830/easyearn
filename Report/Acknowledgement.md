...
First and foremost, I would like to express my deepest gratitude to my project supervisor, Mr On Siang Aik, for the invaluable guidance, constructive feedback, and continuous encouragement throughout the entire duration of this Final Year Project. His expertise and patience have been instrumental in shaping both the direction and quality of this work.
...
I am also grateful to my friends and fellow classmates for their moral support, thoughtful discussions, and shared experiences throughout this journey.

Finally, I acknowledge the open-source communities and documentation behind HTML, CSS, JavaScript, and Supabase, as well as the many academic authors whose published works have informed and enriched the theoretical foundation of this project.
