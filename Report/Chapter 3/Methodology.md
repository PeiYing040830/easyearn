...
To identify the user requirements for the EasyEarn Job Matching Portal, the approach of this study was mainly quantitative research (Creswell, 2014; Saunders et al., 2019). In order to gather measurable answers from the potential users about their existing job search or hiring experience, and the value they placed on elements that would be included in a short-term job-matching platform, a structured online survey was used. The majority of the questions in the questionnaire were closed questions, such as multiple choice, checkboxes, five-point scale and multiple choice grid. Data were summarised into frequencies, percentages and rating distributions for these responses.

At the end of the questionnaire, an open-ended question was also added for respondents to make some more suggestions for the system. The quantitative approach was chosen as it allows the study to reveal the common needs of users and to identify and compare the level of importance for different EasyEarn features. The findings were utilised as supporting resources in the other system requirements identified related to location-based job searching, safety and trust, work history, multilingual accessibility and short-term job management.
...
| --- | --- | --- |
| Respondent Background | Q1-Q5 | Collect consent, demographic information, intended user role and location. |
| Current Job Search / Hiring Experience | Q6-Q9 | Identify current experience, channels, problems and level of difficulty. |
...
The multiple-choice questions were analysed by frequencies and percentages. If multiple responses were possible for a question, the number and percentage of respondents that chose each response were noted. Answer distributions and average scores were used to examine the five-point rating questions, in order to find out the general difficulty level of the questions and the importance of the features in each proposed question.
...
Feedback through the user requirement survey included their experience with searching for and finding short-term jobs, as well as their hopes for EasyEarn. There were 30 valid responses received from the 20th to the 23rd April 2026.

The 30 respondents identified as Job Seekers (66.7%), Employers / Hirers (16.7%) and both Job Seekers and Employers / Hirers (16.7%). The respondents were from 13 different states in Malaysia. Figure 3.2 presents respondents' intended platform role.

![Figure 14](Diagram/figure-14.png)

Figure 3.2: Distribution of Respondents by Intended Platform Role

30 of all respondents had previously tried or offered to search for or perform short-term, part-time or freelance work. Of these, 20 (66.7%) indicated that they do so very often, 8 (26.7%) do so often, and 2 (6.7%) do so once or twice.

26 respondents (86.7%) checked the Very Difficult level for the difficulty of finding suitable short-term jobs or workers in their area, and 4 respondents (13.3%) checked the Difficult level. The average score across the respondents was 4.87 (out of 5), showing that respondents felt that the ability to recruit short-term workers to their area was relatively high. The responses are displayed in Figure 3.3.

Figure 3.3: Difficulty in Finding Suitable Short-Term Jobs or Workers

![Figure 15](Diagram/figure-15.png)

There were also some issues regarding the short-term search and recruitment of jobs. Difficulty finding jobs/workers in the area, fake or suspicious jobs posted, and unclear job information and unverified employers: All 30 respondents indicated these as problems/concerns. 29 respondents chose other problems, such as difficulties in assessing applicant reliability, lack of work history, language problems, limited flexible-work opportunities and difficulties in handling applications. These findings are summarised in Figure 3.4.

![Figure 16](Diagram/figure-16.png)

Figure 3.4: Problems in Short-Term Job Search and Hiring

A preference for multilingual accessibility was also revealed in the survey. 25 respondents (83.3%) chose English, 22 respondents (73.3%) chose Mandarin, 21 respondents (70.0%) chose Bahasa Melayu, and 6 respondents (20.0%) chose Tamil. Percentages are greater than 100%, as respondents could check as many languages as they wished. From these results, it is clear that having access to multiple languages would be beneficial for EasyEarn users.

All of the EasyEarn features have been rated highly. Job Search by Location, Job Search by Category, Application Status Tracking, Employer Verification Badge, Report and Flag System, Work History Profile and Multilingual Access each had a mean rating of 5.00 out of 5.00. The Two-way Rating and Review System and Auto-Generated PDF Resume were both rated an average of 4.97 out of 5.00, while the Rule-Based Chatbot Support scored an average of 4.97 out of 5.00. Figure 3.5: Importance Ratings of the Ten proposed EasyEarn features.
...
When asked about the most important factor when using a short-term job platform, 9 respondents (30.0%) said that it was easy to use the interface, 7 respondents (23.3%) said that it was easy to use the application / manage the applicant and 5 respondents (16.7%) said that safety and employer verification was the most important factors. Four respondents (13.3%) selected Work History and Resume Features and two respondents (6.7%) selected Jobs Available in My Location and Flexible Job Opportunities. 1 respondent (3.3%) chose Multilingual Support. The results are shown in Figure 3.6. The top three are already listed in your current report as 30.0%, 23.3% and 16.7%.

Figure 3.6: Most Important Factor When Using a Short-Term Job Platform

![Figure 20](Diagram/figure-20.png)

The open-ended responses included some further ideas for EasyEarn. These covered new job and application alerts; salary and payment filters; scheduling and reminders for interviews; new security alerts; enhanced profile and resume capabilities; and improved accessibility. These are merely suggestions and can be included as future improvements depending on the scope of work, development time and resources available.
...
EasyEarn was built with a Hybrid Agile-Waterfall methodology, a combination of the iterative flexible development of Agile with the structured planning of the Waterfall. This method was chosen to align with the fixed 26-week Final Year Project period and EasyEarn is a multi-modular system (Pressman & Maxim, 2020; Sommerville, 2016).
...
| Step | Description |
| --- | --- |
| Planning | The beginning of every sprint involves developing sprint goals, user stories, and acceptance criteria to have a clear scope and expected outcomes. |
| Design | UI wireframes, Supabase collection schema refinements, and workflow plans of the system are ready to assist with the targeted features of the sprint. |
| Development | The implementation of features is done in HTML, CSS, JavaScript, and the Supabase JavaScript Client Library with modular, maintainable and testable code. |
| Testing | Sprint testing is done through unit testing, integration testing and defect removal to ensure the stability of the system. |
| Deployment | The features are done, and they are added to GitHub Pages, where a stable and working increment is available to be reviewed. |
| Review | Sprint review and retrospective meetings are conducted with the project supervisor to show which features are done and receive comments on the following sprint. |
...
A formal log is used to record progress in development every week. Tasks which have been done and problems which have been faced are recorded as a reference to the supervisors.
...
Sprint review will be held at the end of every sprint, which shows the supervisor what has been accomplished. Feedback is documented in order to make better improvements in subsequent sprints.
...
The FYP2 development will be organised into six two-week Agile sprints (Week 9 - Week 20), each delivering a functional system module. The development of the sprint will start on 15 June 2026 after the submission of the FYP1 final. Table 3.4 lists all 26 weeks of the project development along with the project phases: Breakdown, Objectives, Key activities and Deliverables for EasyEarn.
...
| Sprint | Timeline | Objective | Key Activities | Deliverable |
| --- | --- | --- | --- | --- |
...
| --- | --- | --- |
| Frontend | HTML, CSS, JavaScript | All user role dashboards- user interface design and development. |
| Database | Supabase PostgreSQL | User, job, application, rating and work history Cloud relational database. |
| Authentication | Supabase Authentication | Safe user registration, user log on, and user session management. |
...
| Code Editor | Visual Studio Code | Main development platform of HTML, CSS and JavaScript. |
| Design | Canva | UI wireframe design, poster design and visual asset design. |
| Documentation | Microsoft Word | Report preparation, technical documentation and proposal writing. |

## 3.6 Planning

Planning is a key part of projects to ensure they are completed within scope, on schedule and to a required quality (PMI, 2021). For EasyEarn, the planning phase involves mapping the project goals from Section 1.3 to a structured set of management artefacts that control all activities throughout the project development process that will last for 26 weeks. In this section, three fundamental planning tools are discussed: the Work Breakdown Structure (WBS), the Project Schedule and the Gantt Chart. The WBS breaks the overall project scope into small chunks of work (work packages), the Project Schedule assigns each work package to a timeline, and the Gantt Chart represents the sequence of tasks, task interdependencies and project milestones. These artefacts are the heart of the Hybrid Agile-Waterfall approach outlined in section 3.3, providing the framework and discipline for sprint-based development to take place within a trackable and manageable process.

### 3.6.1 Risk Management

Risk Management consists of a structured approach to identifying, analysing, and controlling risks that can hinder the successful completion of a project (PMI, 2021). The third-party Backend-as-a-Service stack, combined with a tight 26-week development schedule and an academic project being worked on by a single developer, makes proactive identification of risks very important to the project's success in delivering the core system on time and to specification at EasyEarn. Table 3.6 shows the six project risks identified for EasyEarn, are its likelihood and impact ratings, and the mitigation strategies undertaken for these risks.
...
| Storage | 256 GB SSD | 512 GB SSD or above |
...
Software requirements are statements that specify what a system should do (functional requirements) and the constraints that the system should meet (non-functional requirements) (Sommerville, 2016). EasyEarn Software Requirements are organised in this manner.

3.7.1 Functional Requirements

Functional requirements are the services, behaviours and functions the system must offer to its users (Pressman and Maxim 2020). Table 3.8 provides a breakdown of the functional requirements of EasyEarn, grouped by user role and feature and provides a description of what the function needs to provide.
...
Non-functional requirements are the quality characteristics and restrictions that influence the way the system works and how well it performs (Sommerville, 2016). The non-functional requirements for EasyEarn are presented in Table 3.9, which includes performance, security, usability, scalability and regulatory compliance.
...
EasyEarn also contains guidelines that are based on the Employment Act 1955 and promotes fair and appropriate practices in job posting. These include awareness of minimum wage and clear information about jobs in listings. The academic prototype is not intended to implement employment law; however, these reference guidelines complement the platform's dedication to ethical labour practices (Employment Act, 1955). Taken together, these legal and ethical implications are not considered side issues for compliance but foundational design constraints that influence the design of the system, how data is handled, and the user interface. EasyEarn is recognised as an academic prototype and needs to be subject to a formal regulatory compliance audit before production deployment to the public.
...
System design converts the requirements specification into a blueprint for building the software, including the design of the software's architecture, data structures, interfaces, and procedural details (Pressman & Maxim, 2020). This section includes detailed design of the entire system pertaining to the development framework, system architecture, module division, Database design, Use case diagram and System workflow diagrams.
...
The ratings table is used to support a bidirectional rating system, referencing the applications table and users table, both as the reviewer and as the application to be rated. The work_history table is automatically filled when the job is completed, and references both the job seeker (seekers_id) and the completed application (applications_id). Payment confirmations and disputes are saved in the payments table, and all user-flagged payments and reports for admin review are saved in the reports table.

There are supporting tables such as saved_jobs for the job wishlist feature, notifications for generated system alerts, analytics for aggregating platform-wide metrics, chatbot_knowledge for the rule-based chatbot knowledge base and chatbot_logs for the interaction history. All tables are primary keyed with Universally Unique Identifier (UUIDs), which are globally unique and are resistant to enumeration attacks (Leach et al., 2005).

![Figure 27](Diagram/figure-27.png)

Figure 3.13: Entity-Relationship Diagram (ERD)
...
The users table is the central table of the EasyEarn database. It contains all registered user accounts, including job seekers, employers and administrators. The personal profile information like skills, availability, education, and similar data, is stored in a single record along with the employer-specific data like Suruhanjaya Syarikat Malaysia (SSM) number, verification documents, etc., and irrelevant fields are kept as NULL based on the role of the user. Table 3.10 shows the data dictionary for the users table, which defines the names, data types, constraints, and descriptions of the table columns.
...
| preferred_categories | TEXT[] | NULL | Job categories the seeker is interested in |
...
| ssm_number | TEXT | NULL | SSM company registration number |
| verification_status | TEXT | NULL | Verification state: pending/approved/rejected |
| verification_address | TEXT | NULL | Registered business address |
| registration_doc_name | TEXT | NULL | SSM document file name |
| registration_doc_data | TEXT | NULL | SSM document stored as base64 |
...
| interview_notes | TEXT | NULL | Employer notes on the interview |
| interview_location | TEXT | NULL | Interview venue or Google Meet |
| attendance_confirmed_at | TIMESTAMP | NULL | Timestamp when attendance was confirmed |
| deleted_at | TIMESTAMP | NULL | Soft delete timestamp; NULL means active |
...
| Column Name | Data Type | Constraint | Description |
| --- | --- | --- | --- |
| id | UUID | PK, NOT NULL | Unique identifier for each payment record |
| application_id | UUID | FK → applications.id | Application this payment is linked to |
...
| payee_confirmed | BOOLEAN | DEFAULT false | Whether the payee confirmed receipt |
| confirmed_at | TIMESTAMP | NULL | Timestamp when payment was confirmed |
| disputed_at | TIMESTAMP | NULL | Timestamp when the dispute was raised |
| resolved_at | TIMESTAMP | NULL | Timestamp when the dispute was resolved |
| employer_paid_at | TIMESTAMP | NULL | Timestamp employer marked as paid |
| seeker_confirmed_at | TIMESTAMP | NULL | Timestamp seeker acknowledged receipt |
| deleted_at | TIMESTAMP | NULL | Soft delete timestamp; NULL means active |
| created_at | TIMESTAMP | DEFAULT now() | Record creation timestamp |

#### 3.9.5.5 ratings

The ratings table enables both EasyEarn and job seekers to rate each other after a job, thereby implementing a bidirectional rating system. Each rating is attached to a specific use, and it includes the role that the user placed it in, the star score and an optional written rating in order to create a platform of trust and accountability. The data dictionary for the ratings table is shown in Table 3.14, which lists the columns that are used to implement the bidirectional ratings and reviews between employers and job seekers.

Table 3.14: Data Dictionary - ratings

| Column Name | Data Type | Constraint | Description |
| --- | --- | --- | --- |
| id | UUID | PK, NOT NULL | Unique identifier for each rating record |
| application_id | UUID | FK → applications.id | Completed application this rating is for |
| reviewer_id | UUID | FK → users.id | The user who submitted the rating |
| reviewee_id | UUID | FK → users.id | The user who received the rating |
| reviewer_role | TEXT | NULL | Role of the reviewer: employer / job_seeker |
| stars | INTEGER | NULL | Star rating from 1 (lowest) to 5 (highest) |
| review | TEXT | NULL | Written review comment |
| created_at | TIMESTAMP | DEFAULT now() | Timestamp when the rating was submitted |
...
| Column Name | Data Type | Constraint | Description |
| --- | --- | --- | --- |
| id | UUID | PK, NOT NULL | Unique identifier for each report record |
...
| Column Name | Data Type | Constraint | Description |
| --- | --- | --- | --- |
| id | UUID | PK, NOT NULL | Unique identifier for each saved job record |
| seeker_id | UUID | FK → users.id | Job Seeker who marked this listing as a favourite |
| job_id | UUID | FK → job_listings.id | Job listing that was saved |
| saved_at | TIMESTAMP | DEFAULT now() | Timestamp when the job was saved |
...
| Column Name | Data Type | Constraint | Description |
| --- | --- | --- | --- |
| id | UUID | PK, NOT NULL | Unique identifier for each work history entry |
| seeker_id | UUID | FK → users.id | Job seeker, this record belongs to you |
...
| user_id | UUID | FK → users.id | The user who receives this notification |
| actor_id | UUID | FK → users.id | The user who triggered the notification event |
| type | TEXT | NULL | Notification type (e.g. application_update) |
| message | TEXT | NULL | The notification message content is displayed to the user |
| is_read | BOOLEAN | DEFAULT false | Whether the user has read this notification |
| is_admin | BOOLEAN | DEFAULT false | Whether this is an admin-targeted notification |
| target_table | TEXT | NULL | Name of the related database table |
| target_id | UUID | NULL | UUID of the related record in target_table |
...
| Column Name | Data Type | Constraint | Description |
| --- | --- | --- | --- |
| id | UUID | PK, NOT NULL | Unique identifier for each knowledge entry |
| question | TEXT | NOT NULL | Sample question used for chatbot matching |
| answer | TEXT | NOT NULL | Chatbot response returned when matched |
| keywords | TEXT[] | NULL | An array of keywords to match logic based on rules |
| category | TEXT | NULL | Knowledge category: general / jobs |
| usage_count | INTEGER | DEFAULT 0 | Number of times this entry has been matched |
| created_at | TIMESTAMP | DEFAULT now() | Timestamp when the entry was created |
...
| Column Name | Data Type | Constraint | Description |
| --- | --- | --- | --- |
| id | UUID | PK, NOT NULL | Unique identifier for each chatbot interaction log |
| user_id | UUID | FK → users.id | User who interacted with the chatbot; NULL if anonymous |
| question | TEXT | NULL | Question or message sent by the user |
| answer | TEXT | NULL | Response returned by the chatbot |
| matched | BOOLEAN | DEFAULT false | Whether the question is a match for a knowledge base |
| confidence_score | NUMERIC | NULL | Matching confidence score from the rule-based engine |
| created_at | TIMESTAMP | DEFAULT now() | Timestamp when the interaction was logged |
...
| Column Name | Data Type | Constraint | Description |
| --- | --- | --- | --- |
| id | UUID | PK, NOT NULL | Unique identifier for each analytics snapshot |
| recorded_at | DATE | DEFAULT CURRENT_DATE | Date this snapshot was recorded |
| total_users | INTEGER | DEFAULT 0 | Total number of registered user accounts |
| total_seekers | INTEGER | DEFAULT 0 | Total number of job seeker accounts |
| total_employers | INTEGER | DEFAULT 0 | Total number of employer accounts |
| active_listings | INTEGER | DEFAULT 0 | Number of currently active job listings |
| total_apps | INTEGER | DEFAULT 0 | Total number of applications submitted |
| successful_matches | INTEGER | DEFAULT 0 | Total number of completed jobs |
...
Employer registration is done through an Employer Code and submission of Employer KYB documents (SSM number and Business documents) to the Administrator for review. The employer will be issued a Verification Badge upon approval. The employer then publishes jobs, checks in applicants' profiles, accepts and rejects applicants, arranges interviews, records the attendance of the job seeker, uploads evidence of payment and rates the job seeker.
...
Wireframes are low-fidelity sketches of a user interface that outline the elements, hierarchy and functionality of each screen without being concerned with the visual design elements like typography and colour (Garrett, 2011). The wireframes were created using the Canva app and act as the UI/UX prototype for the EasyEarn project throughout the Agile sprint phases. Below, each wireframe is shown with a description of its main features and the reasoning behind its design.
...
### 3.11.6 Job Seeker Resume Builder

The Resume Builder page uses the Auto-Generate Resume feature (FR09) and uses the jsPDF library to construct a professional, downloadable PDF resume directly from the job seeker's Supabase profile without any manual input or formatting from the user (Hall, 2025). In the top navigation bar, there is a button named "Refresh from Profile" that fetches the latest data from Supabase and then re-renders the resume in real time. There's also a 'Download PDF' button that does the following: if you have jsPDF installed, it will use that rendering engine to create the PDF file on the client side.
...
### 3.9.10 Admin Dashboard

The Admin Dashboard gives the Administrator an overview of the platform. The four statistics cards at the top of the screen show the total number of Users (1,248), Reports (132), Verifications (76), and Jobs (342), and include a weekly change indicator. The two main buttons, "Open Reports" and "Review Verifications", are prominently displayed. The lower part of the dashboard breaks down into a Moderation Queue panel, which displays any reports, verifications or job listings that need attention from the admin, and a Database Distribution Metrics panel, which displays a doughnut chart generated using Chart.js that shows the relative distribution of platform data by Users, Reports, Verifications and Jobs.
...
### 3.11.11 Admin Job Listing Moderation
...
This section presents the key implemented user interface screens of the EasyEarn Job Matching Portal, developed based on the wireframe prototypes in Section 3.9.
...
The Registration Page can be used by new users to register on EasyEarn. There are two sections of the form: Job Seeker and Employer, with the form fields adjusted dynamically based on the selection. In both cases, the form requests the user's complete name, email address, password, cellphone number and region or city. Employers are also required to enter the type of business (Individual or Company). If the registration form is successfully submitted, then a user account is created on Supabase with the role selected and the permissions associated with that role. The Terms and Conditions must be accepted prior to filling out the Registration Form. The collection and processing of personal information are based on the notice, consent and security principles in PDPA 2010. After successful Registration the user will be redirected to the Login Page. A Registration Page was implemented as shown in Figure 3.38 having sections split up according to the user's (Job Seeker/Emp) role in signing up for an account.
...
Job Seekers will be able to see their completed gigs on their Work History page and update their resumes and earnings tracking. Completed work records are created from completed job engagements and stored in the Supabase work_history table. It has an overview of the significant metrics such as total finished jobs, total income and top category. It also has a Work record form with the details of the job, including the Company, Job category, location, completion date, earnings, rating, work period and highlights. A resume readiness panel displays the number of work records that have been stored and if the resume is ready or not with a link to the Resume page. The Recent Work Record section shows work entries completed that are saved in the work_history table. There is a Rate Employer modal too, which lets a Job Seeker rate the employer 1-5 stars and write a review of the employer (optional). The design of the Work History Page in EasyEarn is shown in Figure 3.50, which consists of the metrics summary, work record form, resume readiness panel and Rate Employer modal.
...
![Figure 163](Diagram/figure-163.png)
...
![Figure 172](Diagram/figure-172.png)
